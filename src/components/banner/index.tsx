...
const Banner = () => {
    return (
        <div className="grid lg:grid-cols-[1fr,max-content] xl:grid-cols-[42%,1fr] gap-x-10  border-b-[0.5px] border-black border-solid">
        <div className="pt-[6%] grid grid-rows-[max-content,1fr,max-content] items-center">
          <div className="lg:ml-[5vw] max-lg:p-[7%] pt-[12.4%] max-lg:text-center max-w-[800px] max-lg:mx-auto">
            <h1 className="text-4xl md:text-5xl xl:text-6xl leading-[1.1] font-extrabold text-black">
